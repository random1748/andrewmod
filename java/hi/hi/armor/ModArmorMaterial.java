...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    SKEPPU(andrewmod.MOD_ID + ":skeppu", 25, new int[] { 20, 50, 60, 20 }, 180,
            SoundEvents.MUSIC_DISC_PIGSTEP, 10000, () -> { return Ingredient.fromItems(RegistryHandler.SKEPPUINGOT.get()); },5.00F);
